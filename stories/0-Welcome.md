...
<table>
  ...
  <tr>
    <td>You should change the default admin password.</td>
    <td>Change the admin password</td>
  </tr>
  <tr>
...
<ul>
  ...
  <li> CIDR for Classless inter-domain routing </li>           
  <li> DN for Distinguished Name </li>                      
  <li> DNS for Domain Name System </li>                    
  <li> GB for Gigabytes </li>
  <li> ID for Identification </li>
  <li> IP for Internet Protocol </li>                          
  <li> KB for Kilobytes </li>
  <li> LDAP for Lightweight Directory Access Protocol </li>   
  <li> Max for Maximum [Mastering] </li>                  
  <li> MB for Megabytes </li>
  <li> MCU  for MarkLogic Capacity Unit </li>                  
  <li> MLCP for MarkLogic Content Pump [Ingestion step] </li>
  <li> ODB for Open Database Connectivity </li>       
  <li> PII for Personally Identifiable Information [Entities] </li>
  <li> TB for Terabytes </li>
  <li> URI for Uniform Resource Identifier </li>              
  <li> URI for Uniform Resource Identifier [Across app] </li>
  <li> VNET for Azure Virtual Network </li>
  <li> VPC for Virtual Private Cloud </li>
</ul>

Only use these approved acronyms:
<ul>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#ACID">ACID</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#BLOB">BLOB</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#CRUD">CRUD</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#CURIE">CURIE</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#FLWOR_statement">FLWOR</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#JSON">JSON</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#LDAP">LDAP</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#MIME_type">MIME</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#PEP">PEP</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#POJO">POJO</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#REST">REST</a> </li> 
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#SKOS">SKOS</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#SOAP">SOAP</a> </li>
  <li> <a href="https://docs.marklogic.com/guide/copyright/glossary#URN">URN</a> </li>
</ul>
