...
### Icon Colors
* Link icons and save icons are component purple (#5B69AF) 
![Save icon](images/save_icon.png)
* Utility icons are #777777 (example expand all / collapse all icons) 
![Utility icons](images/utility_icons.png)
* Descriptive / Not clickable icons are text color (generally #333333, or match text color) 
<img src="images/descriptive_icons.png" width="200" />
