...
## Usage Guidelines
Use tooltip on hover to display full contents of truncated text. Center tooltip underneath.

<img src="images/truncated_text_tooltip.png" alt="Example of tooltip" width="200">
